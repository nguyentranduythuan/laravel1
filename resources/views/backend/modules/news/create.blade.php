        ...
        @csrf
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="name" name="title" placeholder="Please enter Category name">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="author" class="form-control" id="name" placeholder="Please enter Aurhor name">
              </div>
            </div>
            ...
            <div class="form-group">
              <label for="intro" class="col-sm-2 control-label">Intro</label>
                <div class="col-sm-10">
                  <textarea cols="60" rows="10" id="intro" name="intro"></textarea>
